...
- The reflectance of a pixel class is a collection of reflectance (https://latex.codecogs.com/gif.latex?R_k%3D%20%5Cleft%20%5C%7B%20r_ki%20%5Cright%20%5C%7D)$R_k={r_ki }$, where $r_ki $ is a random variable representing the reflectance at the location $i=0,1,2,…,n$. Two adjacent reflectance are independent of each other, and the joint probability of is given by $$p(r_ki,r_kj )=p(r_ki )p(r_kj )$$. Based on the same assumption, all reflectance in a pixel class are independent events with joint probability $$p(R_k )=∏_(i=1)^n▒p(r_ki )$$.
